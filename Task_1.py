""" Sentiment_Analysis Project - It'll review your comment """


# Importing the libraries
""" Integration of ML Model using pickel file (it's in Day -54)  """
...
if __name__ == '__main__':
    ...
    To silence this warning, use `int` by itself. Doing this will not modify any behavior 
    and is safe. When replacing `np.int`, you may wish to use e.g. `np.int64` or `np.int32` 
  to specify the precision. If you wish to review your current use, check the release note 
